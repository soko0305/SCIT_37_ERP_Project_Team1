const pages = [
    ...
    },
    {
        ...
        content: {
            ...
            description: 'This dashboard was created as an example of the flexibility that Architect offers.',
    ...
    },
    {
        ...
        content: {
            title: 'Pills Buttons',
            description: 'The pills buttons from Architect Framework have 100% rounded corners.',
    ...
    },
    {
        ...
        content: {
            ...
            description: 'Wide selection of buttons with square corners. Their styling can be added to any button combination.',
            heading_icon: 'pe-7s-car icon-gradient bg-mean-fruit'
        },
    ...
    },
    {
        ...
        content: {
            ...
            description: 'These buttons are examples of buttons with drop shadows attached.',
    ...
    },
    {
        ...
        content: {
            ...
            description: 'These buttons examples contain icons with or without labels attached.',
    ...
    },
    {
        ...
        content: {
            ...
            description: 'Sometimes we need to show a loading indicator for some elements, like cards or tables.',
    ...
    },
    {
        ...
        content: {
            title: 'Count Up',
            description: 'Add animations to your numbers. It\'ll make your next Architect app more user friendly.',
    ...
    },
    {
        ...
        content: {
            title: 'Image Crop',
            description: 'You can easily crop and edit images with this React plugin.',
            heading_icon: 'pe-7s-signal icon-gradient bg-malibu-beach'
        },
    ...
    },
    {
        ...
        content: {
            title: 'Grid Tables',
            description: 'Basic example of a Bootstrap 4 table with sort, search and filter functionality.',
            heading_icon: 'pe-7s-notebook icon-gradient bg-mixed-hopes'
        },
...

    {
        ...
        content: {
            title: 'Chart Boxes',
            description: 'These boxes can be used to show numbers and data in a breautiful user friendly way.',
    ...
    },
    {
        ...
        content: {
            ...
            description: 'Unlimited styles are available for our chart boxes. Check out our dashboard examples for more.',
    ...
    },
    {
        ...
        content: {
            title: 'Apex Charts',
            description: 'Wonderful animated charts built as a jQuery component.',
    ...
    },
    {
        ...
        content: {
            title: 'Sparklines',
            description: 'Use these Sparklines charts inside other components or on their own.',
